  ...
  <div style="padding-top:50px; border:0px solid LightGrey;width:980px;">
    ...
    <el-form label-width="120px" v-model="showMapComponent">
      ...
      <el-form :model="dynamicValidateForm" label-width="100px">
        ...
        <!-- :key="domain.key" -->
        <el-form-item>
          <div style="font-size:26px;color:gray;">代购任务</div>
        </el-form-item>

        <div
          style="margin:0px 0px 20px 110px;padding:0;width:820px;height:1px;background-color:lightGrey;overflow:hidden;"></div>
        ...
        >
          <el-row :gutter="32">
            ...
            <el-col :span="2">
              <el-button v-if="index!=0" @click="removeDomain(domain)" icon="el-icon-minus" type="" circle
                         plain></el-button>
            </el-col>
            <el-col :span="2">
        ...
        <div style="padding-button:5px; border:0px solid LightGrey;width:820px;">
          <el-collapse :according=true>
            <el-collapse-item>
              ...
              <template slot="title">
                <div style="font-size:14px;color:gray;">{{settedReceiver.receiver_name}} @
                  ...
                  <el-table :data="receiverData" highlight-current-row>
                    ...
                    <el-table-column>
                      <template scope="scope">
                        ...
                        <el-button :type="settedReceiver.receiver_name===scope.row.receiver_name?'success':''"
              ...
              <el-row>
                <el-col>
                  <el-button style="float: right;margin-top: 10px;"
                    @click="showDialog()" icon="el-icon-circle-plus-outline" plain>新建</el-button>
                </el-col>
              </el-row>
            </el-collapse-item>
          </el-collapse>
      ...
      submitItem(response) {
        ...
        for (var item in itemList) {
          let completeItem = {
            ...
            item_address: JSON.stringify(this.settedReceiver.receiver_address),
